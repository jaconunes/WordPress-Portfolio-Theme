                ...
                <div class="row">
                    ...
                    <div class="conteudo-post-single col-12">
                        ...
                        <div class="botao-voltar">
                            <a href="<?php echo get_bloginfo ( 'url' ) . '/projeto' ?>" class="botao-voltar-single"><i class="fas fa-long-arrow-alt-left" style="padding-right: 5px;"></i>Ver Todos os Projetos</a>
                        </div>
